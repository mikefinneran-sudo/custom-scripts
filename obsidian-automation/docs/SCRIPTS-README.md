...
**Purpose:** Creates client project update notes
**Features:**
...
| `CLIENT-NOTION-SETUP.md` | Client-specific Notion setup |
| `CLIENT-NOTION-QUICK-SETUP.md` | Quick client Notion integration |
