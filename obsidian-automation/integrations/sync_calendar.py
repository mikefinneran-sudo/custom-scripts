...
def get_calendar_service():
    ...
    token_file = CONFIG_DIR / "calendar_token.json"

    # Fall back to old pickle format for backward compatibility
    old_token_file = VAULT_PATH / ".scripts" / "calendar_token.pickle"
    ...
    if token_file.exists():
        ...
        # Not connected yet
        print("❌ Google Calendar not connected yet.")
        print("\nRun: obs-setup calendar")
